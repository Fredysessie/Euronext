...
```{r En_Market.Sumarry, eval=FALSE}
...
```{r echo=FALSE}
sum_paris = En_Market.Sumarry("p")

print("Summary data for 'Amsterdam stock indices'")
kable(sum_paris$Indices_summary, "html") %>%
  kable_styling(bootstrap_options = "striped")

print("Summary data for 'EURONEXT indices'")
kable(sum_paris$EU_indices, "html") %>%
  kable_styling(bootstrap_options = "striped")

print("Summary data for 'Currency rate'")
kable(sum_paris$Currency_rate, "html") %>%
  kable_styling(bootstrap_options = "striped")
...
```{r EN_OrderBook.Chart, eval=FALSE}
